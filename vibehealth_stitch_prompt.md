# 🐰 VibeHealth — Google Stitch Design Prompt
...
> Paste the full block below into Stitch as your generation prompt. You can do it in multiple passes (one per section) if Stitch has a length limit.

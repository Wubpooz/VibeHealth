...
export class RewardsService {
  ...
  private loadCarrots(): number {
    return parseInt(localStorage.getItem('vibehealth_carrots') || '0', 10);
  }

  private loadStreak(): number {
    return parseInt(localStorage.getItem('vibehealth_streak') || '0', 10);
  }

  private loadLongestStreak(): number {
    return parseInt(localStorage.getItem('vibehealth_longest_streak') || '0', 10);
  }

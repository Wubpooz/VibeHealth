  ...
  template: `
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-50 dark:bg-gray-950 px-4 py-12 transition-colors duration-500">
      ...
      <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-sage-300/20 rounded-full blur-[100px] animate-pulse-slow delay-1000 dark:bg-sage-900/20"></div>
      </div>
        ...
        <div class="glass-panel rounded-3xl p-8 sm:p-10">
          ...
          <form (ngSubmit)="onSubmit()" class="space-y-5">
            ...
            <div class="space-y-2">
              ...
              @if (password && confirmPassword && password !== confirmPassword) {
                <p class="text-xs text-red-500 font-medium ml-1 animate-fade-in">{{ 'AUTH.PASSWORDS_NOT_MATCH' | translate }}</p>
              }
            </div>
          ...
          <div class="relative my-8">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-4 bg-white text-gray-500 font-medium dark:bg-gray-900/80">{{ 'AUTH.OR_SIGN_UP_WITH' | translate }}</span>
            </div>
          </div>
